      ...
      <div class="items">
        ...
        <template v-if="productsInBag.length">
          <div 
            ...
            :key="index" 
            class="item">
            <div class="remove"  @click="this.$store.dispatch('romevoFromBag', product.id)">Remove item</div>
            ...
            <div class="price">
              <span class="quantity-area">
                ...
                <button @click="product.quantity++; this.$store.dispatch('updateQuantity', { index: index, quantity: product.quantity })">+</button>
              </span>
